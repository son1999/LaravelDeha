    ...
    $.ajax({
     ...
     success: function($data) {
      ...
      $.each($data.productType, function(key, value) {
        console.log($data.productType,$data.category);
       ...
       ` 
           <tr>
              ...
              <td>
                  <button class="btn btn-success editProductType"title="sửa` + value.name + `" data-toggle="modal" data-target="#editProductType" type="button" data-id="` + value.id + `"><i class="fas fa-edit"></i></button>
                  <button class="btn btn-danger deleteProductType" data-toggle="modal" data-target="#deleteProductType" type="button"title="Xóa ` + value.name + `" data-id="` + value.id + `"><i class="fas fa-trash-alt"></i></button>
              </td>
            </tr>
          `
  ...
  showviewProductType();
   ...
   $('.updateProductType').click(function() {
     ...
     $.ajax({
      ...
      error: function(data) {
       console.log(data);
       let error = $.parseJSON(data.productType.responseText);
       if (error.errors.name != "") {
        $('.error').show();
        $('.error').text(error.errors.name);
       }
