...
<button type="button" class="btn btn-success float-right d-sm-inline-block" data-toggle="modal" data-target="#add-productType"><i class="fas fa-plus"></i></button>
                    ...
                    <div class="col-xl-8 mb-2 offset-2">
                        <form role="form" id="tableProductType" method="post">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input class="form-control name-productType" name="name" placeholder="Nhập tên category">
                ...
                <div class="row" style="margin: 5px">
                    <div class="col-lg-12 mb-2">
                        <form role="form" id="formProduct" action="{{ route('producttype.store') }}">
                            <fieldset class="form-group">
                                <label>Name</label>
                                <input class="form-control name" id="name" name="name" placeholder="Nhập Loại sản phẩm">
                                <span class="error mt-2 d-lg-block w-100" style="font-size: 16px; color: red !important;"></span>
                            </fieldset>
                            <div class="form-group">
